...
def accounts_upload_path(instance, filename):
    ...
    return 'association/{}/accounts/{}'.format(instance.id, filename)

# Create your models here.

class Account(CustomBaseModel):
    creator = models.ForeignKey(User, to_field='id', related_name='association_account', on_delete=models.DO_NOTHING)
