...
class ExtendedProfile(CustomBaseModel):
    ...
    class Meta:
        db_table = 'association_module_settings_extended_profile'
...
class Subscription(CustomBaseModel):
    ...
    class Meta:
        db_table = 'association_module_settings_subscription'
...
class SubscriptionEvent(CustomBaseModel):
    ...
    class Meta:
        db_table = 'association_module_settings_subscription_event'
