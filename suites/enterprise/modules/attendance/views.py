...
from .models import AttendanceCodeConfig, Attendance
from .serializers import AttendanceCodeConfigSerializer, AttendanceSerializer
...
class AttendanceView(APIView, TablePagination):
    ...
    def get(self, request, format=None):
        ...
        attendance = Attendance.objects.filter(account=account).order_by('-created_at')
...
class AttendanceDetailView(APIView):
    ...
    def put(self, request, id, format=None):
        attendance = Attendance.objects.get(id=id)
        serializer = AttendanceSerializer(attendance, data=request.data, context={'request': request})
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        return Response(serializer.errors)
