...
import suites.enterprise.modules.employees.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to=suites.enterprise.modules.employees.models.employee_upload_path)),
                ...
                ('startedWork', models.DateField(blank=True, null=True)),
                ('endedWork', models.DateField(blank=True, null=True)),
                ('workStatus', models.CharField(blank=True, max_length=32, null=True)),
                ('department', models.CharField(blank=True, max_length=256, null=True)),
                ('job', models.CharField(blank=True, max_length=256, null=True)),
                ('payGrade', models.CharField(blank=True, max_length=128, null=True)),
                ('ssnReference', models.CharField(blank=True, max_length=64, null=True)),
