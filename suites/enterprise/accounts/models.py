...
def accounts_upload_path(instance, filename):
    ...
    return 'enterprise/{}/accounts/{}'.format(instance.id, filename)

# Create your models here.

class Account(CustomBaseModel):
    creator = models.ForeignKey(User, to_field='id', related_name='enterprise_account', on_delete=models.DO_NOTHING)
