...
import suites.school.modules.teachers.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to=suites.school.modules.teachers.models.teacher_upload_path)),
                ...
                ('teacher_code', models.CharField(blank=True, max_length=32, null=True)),
                ('staff_grade', models.CharField(blank=True, max_length=256, null=True)),
