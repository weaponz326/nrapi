...
import suites.hospital.modules.doctors.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to=suites.hospital.modules.doctors.models.doctor_upload_path)),
                ...
                ('doctor_code', models.CharField(blank=True, max_length=32, null=True)),
