...
import suites.hospital.modules.staff.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to=suites.hospital.modules.staff.models.staff_upload_path)),
