...
def patient_upload_path(instance, filename):
    ...
    return 'hospital/{}/modules/patient/{}'.format(instance.account.id, filename)
...
class Patient(CustomBaseModel):
    ...
    photo = models.FileField(null=True, upload_to=patient_upload_path)
    ...
    clinical_number = models.CharField(max_length=32, null=True, blank=True)
    insurance_type = models.CharField(max_length=256, null=True, blank=True)
    insurance_number = models.CharField(max_length=64, null=True, blank=True)

    class Meta:
        db_table = 'hospital_module_patient'

    def __str__(self):
        return str(self.id)

class PatientCodeConfig(CustomBaseModel):
    ...
    class Meta:
        db_table = 'hospital_module_clinical_number_config'
