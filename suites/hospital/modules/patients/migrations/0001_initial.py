...
import suites.hospital.modules.patients.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(null=True, upload_to=suites.hospital.modules.patients.models.patient_upload_path)),
                ...
                ('clinical_number', models.CharField(blank=True, max_length=32, null=True)),
                ('insurance_type', models.CharField(blank=True, max_length=256, null=True)),
