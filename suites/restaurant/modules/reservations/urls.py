...
urlpatterns = [
    ...
    path('config/reservation-code/<id>', views.ReservationCodeConfigDetailView.as_view()),
    path('config/new-reservation-code/<id>', views.NewReservationCodeConfigView.as_view()),
