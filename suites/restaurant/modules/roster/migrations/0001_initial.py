    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant_module_roster.batch', to_field='id')),
                ('roster', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant_module_roster.roster', to_field='id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant_module_roster.batch', to_field='id')),
                ('roster', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant_module_roster.roster', to_field='id')),
                ('shift', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant_module_roster.shift', to_field='id')),
            ],
            options={
