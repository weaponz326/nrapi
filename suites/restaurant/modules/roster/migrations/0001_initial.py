    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roster', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='roster.roster', to_field='id')),
                ('staff', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='staff.staff', to_field='id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='roster.batch')),
                ('roster_day', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='roster.rosterday', to_field='id')),
                ('shift', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='roster.shift')),
            ],
            options={
