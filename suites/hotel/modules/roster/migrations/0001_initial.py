...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hotel_module_staff', '0001_initial'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.batch', to_field='id')),
                ('roster', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.roster', to_field='id')),
                ('staff', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_staff.staff', to_field='id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.batch', to_field='id')),
                ('roster', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.roster', to_field='id')),
                ('shift', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.shift', to_field='id')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='batch',
            name='roster',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='hotel_module_roster.roster', to_field='id'),
        ),
    ]
