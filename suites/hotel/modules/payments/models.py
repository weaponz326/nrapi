...
from suites.hotel.modules.bills.models import Bill
...
class Payment(CustomBaseModel):
    ...
    bill = models.ForeignKey(Bill, to_field='id', on_delete=models.DO_NOTHING, null=True, blank=True)
...
class PaymentCodeConfig(CustomBaseModel):
    ...
    class Meta:
        db_table = 'hotel_module_payment_code_config'
