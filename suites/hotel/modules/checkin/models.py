...
from suites.hotel.modules.bookings.models import Booking
...
class Checkin(CustomBaseModel):
    ...
    booking = models.ForeignKey(Booking, to_field='id', null=True, blank=True, on_delete=models.DO_NOTHING)
